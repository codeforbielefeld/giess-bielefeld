    ...
    <Accordion>
        ...
        <AccordionItem key="wassermenge">
            ...
            <div slot="body">
                ...
                <p>Davon gehen {rain_30_days} l Wasser gehen auf Regen und {watering_30_days} auf Gießungen zurück.</p>
                {#if water_total >= water_requirement_30_days}
                    <p>{tree_name} hat mehr als genug Wasser bekommen.</p>
                {:else}
                    <p>
                        <WaterAlertOutline />
                        {tree_name} braucht noch {additional_water_required} l Wasser.
                        Bitte gieß {tree_name}!
                        <WaterAlertOutline />
                    </p>
                {/if}
            </div>
